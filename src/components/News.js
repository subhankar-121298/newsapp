...
export default class News extends Component {
  ...
  async componentDidMount() {
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=ce294ddc637649e78e8be2641430065d&page=1&pageSize=${this.props.pageSize}`;
    this.setState({
      loading: true,
    });
